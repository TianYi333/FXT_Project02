...
module system
  ...
  system_breath_led_ip_1_0 breath_led_ip_1
       (.led(breath_led_ip_1_led),
        .s0_axi_aclk(processing_system7_0_FCLK_CLK0),
        .s0_axi_araddr(axi_smc_M00_AXI_ARADDR),
        .s0_axi_aresetn(rst_ps7_0_50M_peripheral_aresetn),
        .s0_axi_arprot(axi_smc_M00_AXI_ARPROT),
        .s0_axi_arready(axi_smc_M00_AXI_ARREADY),
        .s0_axi_arvalid(axi_smc_M00_AXI_ARVALID),
        .s0_axi_awaddr(axi_smc_M00_AXI_AWADDR),
        .s0_axi_awprot(axi_smc_M00_AXI_AWPROT),
        .s0_axi_awready(axi_smc_M00_AXI_AWREADY),
        .s0_axi_awvalid(axi_smc_M00_AXI_AWVALID),
        .s0_axi_bready(axi_smc_M00_AXI_BREADY),
        .s0_axi_bresp(axi_smc_M00_AXI_BRESP),
        .s0_axi_bvalid(axi_smc_M00_AXI_BVALID),
        .s0_axi_rdata(axi_smc_M00_AXI_RDATA),
        .s0_axi_rready(axi_smc_M00_AXI_RREADY),
        .s0_axi_rresp(axi_smc_M00_AXI_RRESP),
        .s0_axi_rvalid(axi_smc_M00_AXI_RVALID),
        .s0_axi_wdata(axi_smc_M00_AXI_WDATA),
        .s0_axi_wready(axi_smc_M00_AXI_WREADY),
        .s0_axi_wstrb(axi_smc_M00_AXI_WSTRB),
        .s0_axi_wvalid(axi_smc_M00_AXI_WVALID));
